    ...
    server.registerTool('coolify_audit_standards', {
        ...
        inputSchema: {
            scope: z
                .string()
                .optional()
                .describe('Optional app/db name or UUID to limit the audit to one resource'),
            categories: z
                .array(z.string())
                .optional()
                .describe('Optional check categories to include (default: all)'),
            now: z
                .string()
                .optional()
                .describe('ISO timestamp for age-based checks; caller supplies for determinism'),

...
export function registerDocsTools(server) {
    server.registerTool('coolify_search_docs', {
        title: 'Search Coolify Documentation',
        description: 'Search the official Coolify documentation and return the most relevant sections ' +
        ...
        try {
            ...
            return {
                ...
                content: [
                    {
                        type: 'text',
                        text: `Error: Failed to search Coolify docs — ${error instanceof Error ? error.message : String(error)}`,
                    },
                ],
            };
        }

...
export declare function supabasePost<T>(endpoint: string, data?: Record<string, unknown>): Promise<T>;
...
export declare function supabaseDelete<T>(endpoint: string, data?: Record<string, unknown>): Promise<T>;

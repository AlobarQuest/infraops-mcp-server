...
After this is complete and verified, the next step (a *separate* session) is Plan 3 — the mini-side executor — using the kickoff at `docs/superpowers/kickoffs/change-manager-3-executor.md`.
